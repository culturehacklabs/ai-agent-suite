...
| `KB_02b_Module.md` | Research execution, Big Listening |
...
| `KB_06_Impact_Module.md` | Impact & Iteration, evaluation, case study |
...
- Deeper question about how a concept works in practice, how it connects to other elements, or how to apply it → load the relevant phase KB (e.g., a question about the Window of Discourse beyond a basic definition → load `KB_03_Module.md`)
...
| Design a cultural intervention | Agent 05 — Hack |
| Evaluate impact or document learnings | Agent 06 — Impact & Iteration |
